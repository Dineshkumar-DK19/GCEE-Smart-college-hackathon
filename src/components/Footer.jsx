      ...
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-10 gap-14">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-xs sm:text-sm md:text-base text-slate-400 leading-relaxed max-w-sm">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-xs sm:text-sm md:text-lg font-semibold text-white mb-6 border-b border-white/10 pb-2">
              Events
            </h4>
            <ul className="space-y-4 text-xs sm:text-sm md:text-base text-slate-400">
