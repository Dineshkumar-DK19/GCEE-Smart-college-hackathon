  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto py-12 md:py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-300 text-base sm:text-sm md:text-base max-w-sm">
    ...
    <div className="flex flex-col items-center justify-center text-center">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
       ...
       <motion.div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] bg-gradient-to-b from-lime-500 via-blue-500 to-lime-500 rounded-full"
        >
        </motion.div>
      </div>
    </div>
