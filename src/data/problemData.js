export const problemData = [
  /* ===================== ACCOUNTS OFFICE ===================== */
  {
    ...
    downloads: [
      {
        name: "Admission Form Sample",
        url: "/Admission%20form.pdf",
      },
    ],
    objective:
  ...
  /* ===================== CSE ===================== */
  {
    ...
    dept: "CSE",
    title:
      "A Smart Class Advisor Management System Using Automation Technologies",
    background:
...

  {
    ...
    dept: "EEE",
    title:
      "Digital Attendance Management System with Hourly Tracking and Reporting",
    background:
  ...
  /* ===================== SPORTS ===================== */
  {
    ...
    dept: "Sports",
    title:
      "Mobile Application for Sports Event Management and Indoor Stadium Stock Management",
    background:
      "Currently, the Physical Education department manages sports event information using notice boards, verbal communication, or informal messaging platforms. Indoor stadium stock and sports equipment are maintained through manual registers or basic spreadsheets. These methods are inefficient, prone to data loss and errors, and do not provide real-time visibility. Students often miss event updates, and staff find it difficult to accurately track equipment availability, usage, and loss.",
    description:
  ...
  /* ===================== ZONAL OFFICE ===================== */
  {
    ...
    dept: "Zonal Office",
    title:
      "TNEA Allotment Process Automation – Zone-wise Student Allocation System",
    background:
    ...
    downloads: [
      {
        name: "Input File 1 (70 Round I)",
        url: "/70%20Round%20I%20alloted%20list%20(Input%20file).xlsx",
      },
      {
        name: "Input File 2 (General All TFCs)",
        url: "/ROUND%20I%20GENERAL%20all%20TFCS%20(Input%20file).xlsx",
      },
      {
        name: "Input File 3 (Govt All TFCs)",
        url: "/ROUND%20I%20GOVT%20all%20TFCS%20(Input%20file).xlsx",
      },
      {
        name: "Input File 4 (Colleges List)",
        url: "/TNEA%202025-26%20List%20of%20Colleges%20447%20-%20Nodal%20Officer%20Assigned%20(Input%20File).xlsx",
      },
      {
        name: "Output Format 1 (General)",
        url: "/R1%20GENERAL%20ZONE%20WISE(Required%20Output%20Format%201).xlsx",
      },
      {
        name: "Output Format 2 (Govt)",
        url: "/R1%20GOVT%20ZONE%20WISE(Required%20Output%20Format%202).xlsx",
      },
    ],
    objective:
